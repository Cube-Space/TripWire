...
import net.cubespace.TripWire.Protocol.Packets.Animation;
import net.cubespace.TripWire.Protocol.Packets.AttachEntity;
...
import net.cubespace.TripWire.Protocol.Packets.CollectItem;
import net.cubespace.TripWire.Protocol.Packets.DefinedPacket;
import net.cubespace.TripWire.Protocol.Packets.DestroyEntities;
...
import net.cubespace.TripWire.Protocol.Packets.EntityEffect;
...
import net.cubespace.TripWire.Protocol.Packets.EntityStatus;
...
import net.cubespace.TripWire.Protocol.Packets.MultiBlockChange;
...
import net.cubespace.TripWire.Protocol.Packets.RemoveEntityEffect;
...
import net.cubespace.TripWire.Protocol.Packets.SetExp;
import net.cubespace.TripWire.Protocol.Packets.SoundEffect;
import net.cubespace.TripWire.Protocol.Packets.SpawnExpOrb;
import net.cubespace.TripWire.Protocol.Packets.SpawnMob;
import net.cubespace.TripWire.Protocol.Packets.SpawnObject;
import net.cubespace.TripWire.Protocol.Packets.SpawnPainting;
import net.cubespace.TripWire.Protocol.Packets.SpawnPlayer;
    ...
    GAME {
        {
            ...
            TO_CLIENT.registerPacket(0x0D, CollectItem.class);
            TO_CLIENT.registerPacket(0x0E, SpawnObject.class);
            TO_CLIENT.registerPacket(0x0F, SpawnMob.class);
            TO_CLIENT.registerPacket(0x10, SpawnPainting.class);
            TO_CLIENT.registerPacket(0x11, SpawnExpOrb.class);
            TO_CLIENT.registerPacket(0x12, EntityVelocity.class);
            TO_CLIENT.registerPacket(0x13, DestroyEntities.class);
            ...
            TO_CLIENT.registerPacket(0x1A, EntityStatus.class);
            TO_CLIENT.registerPacket(0x1B, AttachEntity.class);
            TO_CLIENT.registerPacket(0x1C, EntityMetadata.class);
            TO_CLIENT.registerPacket(0x1D, EntityEffect.class);
            TO_CLIENT.registerPacket(0x1E, RemoveEntityEffect.class);
            TO_CLIENT.registerPacket(0x1F, SetExp.class);
            TO_CLIENT.registerPacket(0x20, EntityProperties.class);
            TO_CLIENT.registerPacket(0x21, ChunkData.class);
            TO_CLIENT.registerPacket(0x22, MultiBlockChange.class);
